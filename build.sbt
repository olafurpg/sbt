...
lazy val actionsProj = (project in file("main-actions"))
  ...
  .configure(
    addSbtCompilerClasspath, addSbtUtilCompletion, addSbtCompilerApiInfo, addSbtZinc,
    addSbtCompilerIvyIntegration, addSbtCompilerInterface, addSbtIO, addSbtUtilLogging,
    addSbtUtilRelation, addSbtLm, addSbtUtilTracking
  )
...
lazy val commandProj = (project in file("main-command"))
  ...
  .configure(addSbtCompilerInterface, addSbtIO, addSbtUtilLogging, addSbtUtilCompletion,
    addSbtCompilerClasspath, addSbtLm)
...
lazy val mainSettingsProj = (project in file("main-settings"))
  ...
  .configure(
    addSbtUtilCache, addSbtUtilApplyMacro, addSbtCompilerInterface, addSbtUtilRelation,
...
lazy val mainProj = (project in file("main"))
  ...
  .configure(addSbtCompilerInterface, addSbtIO, addSbtUtilLogging, addSbtUtilLogic, addSbtLm,
    addSbtZincCompile)
...
def allProjects =
  Seq(
    testingProj, testAgentProj, taskProj, stdTaskProj, runProj, scriptedSbtProj,
    scriptedPluginProj, protocolProj, actionsProj, commandProj, mainSettingsProj, mainProj,
    sbtProj, bundledLauncherProj
  )
...
lazy val otherProjects: ScopeFilter = ScopeFilter(
  inProjects(testingProj, testAgentProj, taskProj, scriptedSbtProj, scriptedPluginProj,
    commandProj, mainSettingsProj, mainProj, sbtProj),
  inConfigurations(Test)
)
